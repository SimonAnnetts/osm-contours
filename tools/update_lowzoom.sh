...
#psql -d otm -c "CREATE EXTENSION dblink;"
...
psql -d lowzoom -c "INSERT INTO water SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_water') AS t(way geometry(Geometry,900913), name text, \"natural\" text, waterway text, way_area real);"
...
psql -d lowzoom -c "INSERT INTO landuse SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_landuse') AS t(way geometry(Geometry,900913), landuse text, \"natural\" text);"
...
psql -d lowzoom -c "INSERT INTO roads SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_roads') AS t(way geometry(LineString,900913), highway text, ref text);"
...
psql -d lowzoom -c "INSERT INTO borders SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_borders') AS t(way geometry(LineString,900913), boundary text, admin_level text);"
...
psql -d lowzoom -c "INSERT INTO railways SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_railways') AS t(way geometry(LineString,900913), railway text, \"service\" text, tunnel text);"
...
psql -d lowzoom -c "INSERT INTO cities SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_cities') AS t(way geometry(Point,900913), admin_level text, name text, capital text, place text, population integer);"
...
psql -d lowzoom -c "INSERT INTO lakelabels SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_lakelabel')    AS t(way geometry(LineString,3857), name text, label text, way_area real);"
psql -d lowzoom -c "INSERT INTO lakelabels SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_baylabel')     AS t(way geometry(LineString,3857), name text, label text, way_area real);"
psql -d lowzoom -c "INSERT INTO lakelabels SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_straitplabel') AS t(way geometry(LineString,3857), name text, label text, way_area real);"
psql -d lowzoom -c "INSERT INTO lakelabels SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_straitllabel') AS t(way geometry(LineString,3857), name text, label text, way_area real);"
psql -d lowzoom -c "INSERT INTO lakelabels SELECT * FROM dblink('hostaddr=10.2.6.5 dbname=otm user=osm password=05m\$u53r','SELECT * FROM lowzoom_glacierlabel') AS t(way geometry(LineString,3857), name text, label text, way_area real);"
